...
export const CATEGORY_PALETTE = [
  { key: 'work_spot',     label: 'Work Spots',     color: '#534AB7' },
  { key: 'accommodation', label: 'Accommodations', color: '#D85A30' },
  { key: 'service',       label: 'Services',       color: '#0F6E56' },
  { key: 'transport',     label: 'Transport',     color: '#BA7517' },
  { key: 'attraction',    label: 'Attractions',    color: '#6A1B9A' },
];
